...
selectedPolygonAnomalyIds, onSelectionChange, onReset, showControls, }) => {
    ...
    const initialFromStream = useMemo(() => {
    ...
    const [polygons, setPolygons] = useState(initialFromStream);
    ...
    const deepEqualPolys = useCallback((a, b) => {
        if (a === b)
            return true;
    ...
    // };
    return (jsxs(Card, { className: cn('w-full h-full', className), styles: { body: { padding: 16 } }, children: [jsxs("div", { className: "flex items-center justify-between mb-3", children: [jsxs("div", { children: [jsx(Text, { strong: true, className: "block", children: title }), jsx(Text, { type: "secondary", className: "text-xs", children: subtitle })] }), jsxs("div", { className: "flex items-center gap-3", children: [controlsVisible.viewer && (jsxs("div", { className: "flex items-center gap-2", children: [jsx(Text, { className: "text-xs", children: "Viewer" }), jsx(Switch, { checked: enabled, onChange: setEnabled })] })), controlsVisible.draw && (jsxs("div", { className: "flex items-center gap-2", children: [jsx(Text, { className: "text-xs", children: "Draw" }), jsx(Switch, { checked: drawingEnabled, onChange: setDrawingEnabled })] })), controlsVisible.reset && (jsx(Button, { size: "small", onClick: handleReset, disabled: !enabled, icon: jsx(ReloadOutlined, {}), children: "Reset" })), controlsVisible.save && (jsx(Tooltip, { title: selectedIndex == null ? 'Select a polygon to enable Save' : 'Save selected polygon', children: jsx(Button, { size: "small", type: "primary", onClick: handleSaveSelected, disabled: !enabled || selectedIndex == null, children: "Save" }) })), controlsVisible.fullscreen && (jsx(Tooltip, { title: isExpanded ? 'Collapse' : 'Expand', children: jsx(Button, { size: "small", onClick: () => setIsExpanded(v => !v), icon: isExpanded ? jsx(ShrinkOutlined, {}) : jsx(ArrowsAltOutlined, {}) }) }))] })] }), !isExpanded && (jsx("div", { ref: containerRef, className: "relative w-full overflow-hidden rounded-md bg-black", style: { aspectRatio: '16 / 9' }, children: enabled ? (jsxs(Fragment, { children: [jsx(VideoPlayer, { stream: stream, autoPlay: true, muted: true, controls: false, className: "w-full h-full" }), jsx("canvas", { ref: canvasRef, className: "absolute inset-0", style: { pointerEvents: enabled ? 'auto' : 'none', cursor: canDraw ? 'crosshair' : drawingEnabled ? 'default' : 'pointer' }, onClick: handleCanvasClick })] })) : (jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: jsxs("div", { className: "text-center text-gray-300", children: [jsx("div", { className: "text-2xl mb-2", children: "Viewer is OFF" }), jsx("div", { className: "text-sm opacity-80", children: "Toggle ON to start live feed" })] }) })) })), jsxs(Modal, { open: isExpanded, onCancel: () => setIsExpanded(false), footer: null, width: '90vw', style: { top: 24 }, styles: { body: { padding: 16 } }, destroyOnHidden: true, children: [jsxs("div", { className: "flex items-center justify-between mb-3", children: [jsxs("div", { children: [jsx(Text, { strong: true, className: "block", children: title }), jsx(Text, { type: "secondary", className: "text-xs", children: subtitle })] }), jsxs("div", { className: "flex items-center gap-3", children: [controlsVisible.viewer && (jsxs("div", { className: "flex items-center gap-2", children: [jsx(Text, { className: "text-xs", children: "Viewer" }), jsx(Switch, { checked: enabled, onChange: setEnabled })] })), controlsVisible.draw && (jsxs("div", { className: "flex items-center gap-2", children: [jsx(Text, { className: "text-xs", children: "Draw" }), jsx(Switch, { checked: drawingEnabled, onChange: setDrawingEnabled })] })), controlsVisible.reset && (jsx(Button, { size: "small", onClick: handleReset, disabled: !enabled, icon: jsx(ReloadOutlined, {}), children: "Reset" })), controlsVisible.save && (jsx(Tooltip, { title: selectedIndex == null ? 'Select a polygon to enable Save' : 'Save selected polygon', children: jsx(Button, { size: "small", type: "primary", onClick: handleSaveSelected, disabled: !enabled || selectedIndex == null, children: "Save" }) })), controlsVisible.fullscreen && (jsx(Tooltip, { title: 'Collapse', children: jsx(Button, { size: "small", onClick: () => setIsExpanded(false), icon: jsx(ShrinkOutlined, {}) }) }))] })] }), jsx("div", { ref: containerRef, className: "relative w-full overflow-hidden rounded-md bg-black", style: { aspectRatio: '16 / 9' }, children: enabled ? (jsxs(Fragment, { children: [jsx(VideoPlayer, { stream: stream, autoPlay: true, muted: true, controls: false, className: "w-full h-full" }), jsx("canvas", { ref: canvasRef, className: "absolute inset-0", style: { pointerEvents: enabled ? 'auto' : 'none', cursor: canDraw ? 'crosshair' : drawingEnabled ? 'default' : 'pointer' }, onClick: handleCanvasClick })] })) : (jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: jsxs("div", { className: "text-center text-gray-300", children: [jsx("div", { className: "text-2xl mb-2", children: "Viewer is OFF" }), jsx("div", { className: "text-sm opacity-80", children: "Toggle ON to start live feed" })] }) })) })] })] }));
};
