...
initialCalibrationPoints, onCalibrationPointsChange, onSaveCalibrationPoints, onCalibrationReset, }) => {
    ...
    const [calibrationEnabled, setCalibrationEnabled] = React.useState(false);
    const [calibrationPoints, setCalibrationPoints] = React.useState(initialCalibrationPoints ?? []);
    ...
    const formatCalibrationPointsForAPI = React.useCallback((points) => {
        if (points.length === 0)
            return '';
    ...
    const buildCalibrationData = React.useCallback((points) => {
        const pixelPoints = points.map(p => ({
            x: Math.round(p.x * size.width),
            y: Math.round(p.y * size.height)
        }));
    ...
    // };
    return (jsxRuntime.jsxs(antd.Card, { className: cn('w-full h-full', className), styles: { body: { padding: 16 } }, children: [jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-3", children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Text$1, { strong: true, className: "block", children: title }), jsxRuntime.jsx(Text$1, { type: "secondary", className: "text-xs", children: subtitle })] }), jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [controlsVisible.viewer && (jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(Text$1, { className: "text-xs", children: "Viewer" }), jsxRuntime.jsx(antd.Switch, { checked: enabled, onChange: setEnabled })] })), controlsVisible.draw && (jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(Text$1, { className: "text-xs", children: "Draw" }), jsxRuntime.jsx(antd.Switch, { checked: drawingEnabled, onChange: (checked) => {
                                            setDrawingEnabled(checked);
                                            // Disable calibration when enabling draw
                                            if (checked)
                                                setCalibrationEnabled(false);
                                        }, disabled: calibrationEnabled })] })), controlsVisible.reset && (jsxRuntime.jsx(antd.Button, { size: "small", onClick: handleReset, disabled: !enabled, icon: jsxRuntime.jsx(icons.ReloadOutlined, {}), children: "Reset" })), controlsVisible.calibration && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(antd.Tooltip, { title: calibrationEnabled ? 'Calibration mode active (click 4 points)' : 'Enable 4-point calibration mode', children: jsxRuntime.jsx(antd.Button, { size: "small", type: calibrationEnabled ? 'primary' : 'default', onClick: handleCalibrationToggle, disabled: !enabled || calibrationPoints.length === 4, icon: jsxRuntime.jsx(icons.AimOutlined, {}), children: calibrationPoints.length > 0 ? `${calibrationPoints.length}/4` : 'Calibrate' }) }), calibrationPoints.length > 0 && (jsxRuntime.jsx(antd.Tooltip, { title: "Undo last calibration point", children: jsxRuntime.jsx(antd.Button, { size: "small", onClick: handleCalibrationUndo, disabled: !enabled, icon: jsxRuntime.jsx(icons.UndoOutlined, {}) }) })), calibrationPoints.length > 0 && (jsxRuntime.jsx(antd.Tooltip, { title: "Reset all calibration points", children: jsxRuntime.jsx(antd.Button, { size: "small", danger: true, onClick: handleCalibrationReset, disabled: !enabled, children: "Clear" }) })), calibrationPoints.length === 4 && onSaveCalibrationPoints && (jsxRuntime.jsx(antd.Tooltip, { title: "Save calibration points", children: jsxRuntime.jsx(antd.Button, { size: "small", type: "primary", onClick: handleSaveCalibration, disabled: !enabled, children: "Save Calibration" }) }))] })), controlsVisible.save && (jsxRuntime.jsx(antd.Tooltip, { title: selectedIndex == null ? 'Select a polygon to enable Save' : 'Save selected polygon', children: jsxRuntime.jsx(antd.Button, { size: "small", type: "primary", onClick: handleSaveSelected, disabled: !enabled || selectedIndex == null, children: "Save" }) })), controlsVisible.fullscreen && (jsxRuntime.jsx(antd.Tooltip, { title: isExpanded ? 'Collapse' : 'Expand', children: jsxRuntime.jsx(antd.Button, { size: "small", onClick: () => setIsExpanded(v => !v), icon: isExpanded ? jsxRuntime.jsx(icons.ShrinkOutlined, {}) : jsxRuntime.jsx(icons.ArrowsAltOutlined, {}) }) }))] })] }), !isExpanded && (jsxRuntime.jsx("div", { ref: containerRef, className: "relative w-full overflow-hidden rounded-md bg-black isolate", style: { aspectRatio: '16 / 9' }, children: enabled ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(VideoPlayer, { stream: stream, autoPlay: true, muted: true, controls: false, className: "w-full h-full z-0" }), jsxRuntime.jsx("canvas", { ref: canvasRef, className: "absolute inset-0 z-10", style: {
                                pointerEvents: enabled ? 'auto' : 'none',
                                cursor: canCalibrate ? 'crosshair' : canDraw ? 'crosshair' : drawingEnabled ? 'default' : 'pointer'
                            }, onClick: handleCanvasClick })] })) : (jsxRuntime.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: jsxRuntime.jsxs("div", { className: "text-center text-gray-300", children: [jsxRuntime.jsx("div", { className: "text-2xl mb-2", children: "Viewer is OFF" }), jsxRuntime.jsx("div", { className: "text-sm opacity-80", children: "Toggle ON to start live feed" })] }) })) })), jsxRuntime.jsxs(antd.Modal, { open: isExpanded, onCancel: () => setIsExpanded(false), footer: null, width: '90vw', style: { top: 24 }, styles: { body: { padding: 16 } }, destroyOnClose: true, children: [jsxRuntime.jsxs("div", { className: "flex items-center justify-between mb-3", children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Text$1, { strong: true, className: "block", children: title }), jsxRuntime.jsx(Text$1, { type: "secondary", className: "text-xs", children: subtitle })] }), jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [controlsVisible.viewer && (jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(Text$1, { className: "text-xs", children: "Viewer" }), jsxRuntime.jsx(antd.Switch, { checked: enabled, onChange: setEnabled })] })), controlsVisible.draw && (jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsx(Text$1, { className: "text-xs", children: "Draw" }), jsxRuntime.jsx(antd.Switch, { checked: drawingEnabled, onChange: (checked) => {
                                                    setDrawingEnabled(checked);
                                                    if (checked)
                                                        setCalibrationEnabled(false);
                                                }, disabled: calibrationEnabled })] })), controlsVisible.reset && (jsxRuntime.jsx(antd.Button, { size: "small", onClick: handleReset, disabled: !enabled, icon: jsxRuntime.jsx(icons.ReloadOutlined, {}), children: "Reset" })), controlsVisible.calibration && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(antd.Tooltip, { title: calibrationEnabled ? 'Calibration mode active (click 4 points)' : 'Enable 4-point calibration mode', children: jsxRuntime.jsx(antd.Button, { size: "small", type: calibrationEnabled ? 'primary' : 'default', onClick: handleCalibrationToggle, disabled: !enabled || calibrationPoints.length === 4, icon: jsxRuntime.jsx(icons.AimOutlined, {}), children: calibrationPoints.length > 0 ? `${calibrationPoints.length}/4` : 'Calibrate' }) }), calibrationPoints.length > 0 && (jsxRuntime.jsx(antd.Tooltip, { title: "Undo last calibration point", children: jsxRuntime.jsx(antd.Button, { size: "small", onClick: handleCalibrationUndo, disabled: !enabled, icon: jsxRuntime.jsx(icons.UndoOutlined, {}) }) })), calibrationPoints.length > 0 && (jsxRuntime.jsx(antd.Tooltip, { title: "Reset all calibration points", children: jsxRuntime.jsx(antd.Button, { size: "small", danger: true, onClick: handleCalibrationReset, disabled: !enabled, children: "Clear" }) })), calibrationPoints.length === 4 && onSaveCalibrationPoints && (jsxRuntime.jsx(antd.Tooltip, { title: "Save calibration points", children: jsxRuntime.jsx(antd.Button, { size: "small", type: "primary", onClick: handleSaveCalibration, disabled: !enabled, children: "Save Calibration" }) }))] })), controlsVisible.save && (jsxRuntime.jsx(antd.Tooltip, { title: selectedIndex == null ? 'Select a polygon to enable Save' : 'Save selected polygon', children: jsxRuntime.jsx(antd.Button, { size: "small", type: "primary", onClick: handleSaveSelected, disabled: !enabled || selectedIndex == null, children: "Save" }) })), controlsVisible.fullscreen && (jsxRuntime.jsx(antd.Tooltip, { title: 'Collapse', children: jsxRuntime.jsx(antd.Button, { size: "small", onClick: () => setIsExpanded(false), icon: jsxRuntime.jsx(icons.ShrinkOutlined, {}) }) }))] })] }), jsxRuntime.jsx("div", { ref: containerRef, className: "relative w-full overflow-hidden rounded-md bg-black isolate", style: { aspectRatio: '16 / 9' }, children: enabled ? (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(VideoPlayer, { stream: stream, autoPlay: true, muted: true, controls: false, className: "w-full h-full z-0" }), jsxRuntime.jsx("canvas", { ref: canvasRef, className: "absolute inset-0 z-10", style: {
                                        pointerEvents: enabled ? 'auto' : 'none',
                                        cursor: canCalibrate ? 'crosshair' : canDraw ? 'crosshair' : drawingEnabled ? 'default' : 'pointer'
                                    }, onClick: handleCanvasClick })] })) : (jsxRuntime.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: jsxRuntime.jsxs("div", { className: "text-center text-gray-300", children: [jsxRuntime.jsx("div", { className: "text-2xl mb-2", children: "Viewer is OFF" }), jsxRuntime.jsx("div", { className: "text-sm opacity-80", children: "Toggle ON to start live feed" })] }) })) })] })] }));
};
...
const WHEPVideoPlayer = ({ stream, isMuted = true, showControls = true, showLiveIndicator = true, isMain = false, onError, onRetry, onFullscreen, onMuteUnmute, onPlayPause, isPlaying, className = '', whepConfig, }) => {
    ...
    const [, setConnectionError] = React.useState('');
    const [, setCurrentReconnectCount] = React.useState(0);
    ...
    const startStreamHealthMonitor = React.useCallback(() => {
    ...
    const stopStreamHealthMonitor = React.useCallback(() => {
        if (healthCheckIntervalRef.current) {
            clearInterval(healthCheckIntervalRef.current);
            healthCheckIntervalRef.current = null;
        }
    ...
    const handleStreamFailure = React.useCallback((reason) => {
    ...
    const connectToStream = React.useCallback(async () => {
        if (!cameraId) {
            setStatus('error');
    ...
    return (jsxRuntime.jsx("div", { ref: containerRef, className: cn('relative w-full h-full overflow-hidden rounded-lg bg-black', className), style: isMain ? { aspectRatio: '16/9', minHeight: '400px' } : {}, children: status === 'error' && reconnectAttemptsRef.current >= maxReconnectAttempts ? (jsxRuntime.jsx("div", { className: "absolute inset-0 flex flex-col items-center justify-center text-white", children: jsxRuntime.jsxs("div", { className: "text-center", children: [jsxRuntime.jsx("div", { className: "text-lg mb-2", children: "\u26A0\uFE0F" }), jsxRuntime.jsx("div", { className: "text-white mb-4 max-w-xs text-center", children: "Video playback error" }), jsxRuntime.jsx(antd.Button, { type: "primary", icon: jsxRuntime.jsx(icons.ReloadOutlined, {}), onClick: handleRetry, className: "bg-blue-600 hover:bg-blue-700", children: "Retry Connection" })] }) })) : (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("video", { ref: videoRef, className: "w-full h-full object-fill", autoPlay: true, playsInline: true, muted: isMuted }), jsxRuntime.jsxs("div", { className: "absolute top-2 left-2 bg-black/70 text-white text-xs px-2 py-1 rounded flex items-center gap-2", children: [jsxRuntime.jsx("span", { children: cameraName }), showLiveIndicator && status === 'connected' && (jsxRuntime.jsx("span", { className: "px-1 bg-red-600 rounded text-[10px]", children: "LIVE" })), status === 'connecting' && (jsxRuntime.jsxs("span", { className: "px-1 bg-yellow-500 rounded text-[10px] flex items-center gap-1", children: [jsxRuntime.jsx("div", { className: "w-1.5 h-1.5 bg-white rounded-full animate-pulse" }), "Connecting"] })), !isHealthy && status === 'connected' && (jsxRuntime.jsx("span", { className: "px-1 bg-yellow-500 rounded text-[10px]", children: "Buffering" }))] }), showControls && (jsxRuntime.jsxs("div", { className: "absolute top-2 right-2 flex gap-1", children: [jsxRuntime.jsx(antd.Tooltip, { title: isPlaying ? 'Pause' : 'Play', children: jsxRuntime.jsx(antd.Button, { type: "text", size: "small", icon: isPlaying ? jsxRuntime.jsx(icons.PauseOutlined, {}) : jsxRuntime.jsx(icons.PlayCircleOutlined, {}), onClick: (e) => {
                                    e.stopPropagation();
                                    onPlayPause?.();
                                }, className: "text-white hover:text-gray-300 hover:bg-black/20" }) }), jsxRuntime.jsx(antd.Tooltip, { title: isMuted ? 'Unmute' : 'Mute', children: jsxRuntime.jsx(antd.Button, { type: "text", size: "small", icon: isMuted ? jsxRuntime.jsx(icons.MutedOutlined, {}) : jsxRuntime.jsx(icons.SoundOutlined, {}), onClick: (e) => {
                                    e.stopPropagation();
                                    onMuteUnmute?.();
                                }, className: "text-white hover:text-gray-300 hover:bg-black/20" }) }), jsxRuntime.jsx(antd.Tooltip, { title: "Fullscreen", children: jsxRuntime.jsx(antd.Button, { type: "text", size: "small", icon: jsxRuntime.jsx(icons.ArrowsAltOutlined, {}), onClick: (e) => {
                                    e.stopPropagation();
                                    onFullscreen?.();
                                }, className: "text-white hover:text-gray-300 hover:bg-black/20" }) })] })), isMain && (jsxRuntime.jsx("div", { className: "absolute bottom-0 left-0 right-0 px-3 pb-2", children: jsxRuntime.jsx("div", { className: "h-1 bg-white/30 rounded-full overflow-hidden", children: jsxRuntime.jsx("div", { className: "h-full bg-white rounded-full transition-all duration-300", style: { width: status === 'connected' ? '100%' : '0%' } }) }) }))] })) }));
};
/**
...
const WHEPThumbnailGrid = ({ streams, activeStreamIndex, onStreamSelect, layout, maxVisible = 3, whepConfig, }) => {
    ...
    if (streamCount === 2 && layout === 'horizontal') {
        ...
        return (jsxRuntime.jsx("div", { className: "w-full h-full", children: jsxRuntime.jsx("div", { className: "relative w-full h-full overflow-hidden rounded-lg bg-black cursor-pointer hover:ring-2 hover:ring-blue-500 transition-all", onClick: () => onStreamSelect(inactiveIndex), children: jsxRuntime.jsx(WHEPVideoPlayer, { stream: inactiveStream, isMuted: true, showControls: false, showLiveIndicator: true, isMain: false, whepConfig: whepConfig }) }) }));
    }
    if (streamCount >= 3 && layout === 'vertical') {
        const thumbnailStreams = streams
            .map((stream, index) => ({ stream, index }))
            .filter(({ index }) => index !== activeStreamIndex)
            .slice(0, maxVisible);
        return (jsxRuntime.jsx("div", { className: "w-full h-full", children: jsxRuntime.jsx("div", { className: "flex flex-col gap-2 h-full", children: thumbnailStreams.map(({ stream, index }) => (jsxRuntime.jsx("div", { className: "relative overflow-hidden rounded-md bg-black cursor-pointer hover:ring-2 hover:ring-blue-500 transition-all flex-1 min-h-0", onClick: () => onStreamSelect(index), children: jsxRuntime.jsx(WHEPVideoPlayer, { stream: stream, isMuted: true, showControls: false, showLiveIndicator: true, isMain: false, whepConfig: whepConfig }) }, stream.id))) }) }));
    }
    return null;
};
/**
...
const WHEPFullscreenModal = ({ isOpen, stream, isMuted, onClose, onMuteUnmute, whepConfig, }) => {
    if (!isOpen || !stream)
        return null;
    return (jsxRuntime.jsx("div", { className: "fixed inset-0 z-50 bg-black flex items-center justify-center", children: jsxRuntime.jsxs("div", { className: "relative w-full h-full", children: [jsxRuntime.jsx(WHEPVideoPlayer, { stream: stream, isMuted: isMuted, showControls: true, showLiveIndicator: true, isMain: true, onMuteUnmute: onMuteUnmute, onFullscreen: onClose, className: "w-full h-full", whepConfig: whepConfig }), jsxRuntime.jsx(antd.Button, { type: "text", icon: jsxRuntime.jsx(icons.ShrinkOutlined, {}), onClick: onClose, className: "absolute top-4 right-4 text-white hover:text-gray-300 text-xl z-10" })] }) }));
};
/**
...
const LiveFeedWhep = ({ streams = [], className = '', autoPlay = true, muted = true, controls = true, showThumbnails = true, onStreamChange, onError, theme = 'light', title = 'Live Feed', subtitle = 'All pinned cameras will be displayed here', maxThumbnails = 3, enableFullscreen = true, enableKeyboardControls = true, whepConfig, }) => {
    ...
    const [isFullscreen, setIsFullscreen] = React.useState(false);
    const [, setPlayerError] = React.useState(null);
    const streamCount = streams.length;
    const activeStream = streams[activeStreamIndex];
    ...
    const handleStreamChange = React.useCallback((index) => {
    ...
    const handleError = React.useCallback((err, stream) => {
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(antd.Card, { className: cn('w-full h-full', themeClasses[theme], className), styles: { body: { padding: 16, height: '100%' } }, children: jsxRuntime.jsxs("div", { className: "flex flex-col h-full", children: [jsxRuntime.jsx("div", { className: "mb-4 flex-shrink-0", children: jsxRuntime.jsxs("div", { className: "flex items-center justify-between", children: [jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx(Text, { strong: true, className: "text-base block", children: title }), jsxRuntime.jsx(Text, { type: "secondary", className: "text-sm", children: subtitle })] }), enableKeyboardControls && (jsxRuntime.jsx("div", { className: "text-xs text-gray-400", children: jsxRuntime.jsx(Text, { type: "secondary", className: "text-xs", children: "Keyboard: Space (play/pause), M (mute), F (fullscreen), \u2190\u2192 (switch)" }) }))] }) }), jsxRuntime.jsxs("div", { className: layoutClasses.container, children: [jsxRuntime.jsx("div", { className: layoutClasses.mainVideo, children: jsxRuntime.jsx(WHEPVideoPlayer, { stream: activeStream, isMuted: isMuted, showControls: controls && streamCount > 2, showLiveIndicator: true, isMain: true, isPlaying: isPlaying, onError: handleError, onRetry: handleRetry, onFullscreen: toggleFullscreen, onMuteUnmute: toggleMute, onPlayPause: togglePlayPause, whepConfig: whepConfig }) }), showThumbnails && streamCount > 1 && (jsxRuntime.jsx("div", { className: layoutClasses.thumbnailContainer, children: jsxRuntime.jsx(WHEPThumbnailGrid, { streams: streams, activeStreamIndex: activeStreamIndex, onStreamSelect: handleStreamChange, onFullscreen: toggleFullscreen, layout: streamCount === 2 ? 'horizontal' : 'vertical', maxVisible: maxThumbnails, whepConfig: whepConfig }) }))] })] }) }), enableFullscreen && (jsxRuntime.jsx(WHEPFullscreenModal, { isOpen: isFullscreen, stream: activeStream, isMuted: isMuted, onClose: toggleFullscreen, onMuteUnmute: toggleMute, whepConfig: whepConfig }))] }));
};
...
onClick, onError, className, style, }) => {
    ...
    const handleSelectionToggle = React.useCallback((e) => {
        e.stopPropagation();
    ...
    // Empty slot
    if (!hasStream) {
        return (jsxRuntime.jsx("div", { className: cn('relative bg-gray-900 rounded-lg overflow-hidden flex items-center justify-center', className), style: style, children: jsxRuntime.jsxs("div", { className: "text-center text-gray-500", children: [jsxRuntime.jsx("svg", { className: "w-12 h-12 mx-auto mb-2 opacity-50", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" }) }), jsxRuntime.jsx("span", { className: "text-sm", children: "No camera" })] }) }));
    }
    return (jsxRuntime.jsxs("div", { ref: containerRef, className: cn('relative bg-gray-900 rounded-lg overflow-hidden group', isSelected && 'ring-2 ring-blue-500 ring-offset-2 ring-offset-gray-900', className), style: style, onClick: handleClick, children: [jsxRuntime.jsx("video", { ref: videoRef, className: "w-full h-full object-cover", autoPlay: true, playsInline: true, muted: true }), enableSelection && (jsxRuntime.jsx("div", { className: "absolute top-2 left-2 z-20", children: jsxRuntime.jsx("label", { className: "flex items-center cursor-pointer", onClick: handleSelectionToggle, children: jsxRuntime.jsx("input", { type: "checkbox", checked: isSelected, onChange: () => { }, className: "w-5 h-5 rounded border-2 border-white bg-black/40 text-blue-500 \n                         focus:ring-blue-500 focus:ring-offset-0 cursor-pointer\n                         checked:bg-blue-500 checked:border-blue-500" }) }) })), showLabel && (jsxRuntime.jsx("div", { className: cn('absolute left-2 bg-black/60 text-white px-3 py-1 rounded text-sm font-medium z-10', labelPlacement === 'top' ? 'top-2' : 'bottom-2', enableSelection && labelPlacement === 'top' && 'left-10'), children: cameraName })), jsxRuntime.jsxs("div", { className: "absolute top-2 right-2 flex flex-col items-end gap-1 z-10", children: [status === 'connecting' && (jsxRuntime.jsxs("div", { className: "bg-yellow-500 text-white px-2 py-1 rounded text-xs flex items-center gap-1", children: [jsxRuntime.jsx("div", { className: "w-2 h-2 bg-white rounded-full animate-pulse" }), "Connecting"] })), status === 'connected' && (jsxRuntime.jsxs("div", { className: cn('text-white px-2 py-1 rounded text-xs flex items-center gap-1', isHealthy ? 'bg-green-500' : 'bg-yellow-500'), children: [jsxRuntime.jsx("div", { className: cn('w-2 h-2 bg-white rounded-full', !isHealthy && 'animate-pulse') }), isHealthy ? 'Live' : 'Buffering'] })), status === 'error' && reconnectCount > 0 && reconnectCount < maxReconnectAttempts && (jsxRuntime.jsxs("div", { className: "bg-orange-500 text-white px-2 py-0.5 rounded text-[10px]", children: ["Retry: ", reconnectCount, "/", maxReconnectAttempts] }))] }), showControls && status === 'connected' && (jsxRuntime.jsx("div", { className: "absolute bottom-2 right-2 flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity z-10", children: jsxRuntime.jsx("button", { onClick: (e) => {
                        e.stopPropagation();
                        toggleFullscreen();
                    }, className: "bg-black/60 hover:bg-black/80 text-white p-2 rounded transition-colors", title: isFullscreen ? "Exit Fullscreen" : "Fullscreen", children: isFullscreen ? (jsxRuntime.jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })) : (jsxRuntime.jsx("svg", { className: "w-4 h-4", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4" }) })) }) })), (status === 'disconnected' || status === 'error') && (jsxRuntime.jsx("div", { className: "absolute inset-0 flex items-center justify-center bg-gray-900", children: jsxRuntime.jsxs("div", { className: "text-center text-gray-400", children: [jsxRuntime.jsx("svg", { className: "w-16 h-16 mx-auto mb-2 opacity-50", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" }) }), jsxRuntime.jsx("p", { className: "text-sm font-medium", children: status === 'error' ? 'Failed to fetch' : 'No Signal' }), reconnectAttemptsRef.current > 0 && reconnectAttemptsRef.current < maxReconnectAttempts && (jsxRuntime.jsxs("p", { className: "text-xs mt-2", children: ["Reconnecting in ", Math.ceil(reconnectDelay / 1000), "s..."] })), reconnectAttemptsRef.current >= maxReconnectAttempts && (jsxRuntime.jsx("button", { onClick: (e) => {
                                e.stopPropagation();
                                handleRetry();
...
const WHEPVideoTile = React.memo(WHEPVideoTileInner);
...
const LiveVideosWhep = ({ streams, whepConfig, gridLayout, defaultGridLayout = DEFAULT_LAYOUT, availableLayouts = ALL_LAYOUTS, loading = false, title = DEFAULT_TITLE, onLayoutChange, onTileClick, onStreamError, onSelectionChange, showLayoutSelector = true, showTileLabels = true, tileLabelPlacement = 'top', showTileControls = true, enableTileSelection = false, enableOpenInLayout = false, layoutViewerPath = '/layout-viewer', height = DEFAULT_HEIGHT, className, emptyState, }) => {
    ...
    const [internalLayout, setInternalLayout] = React.useState(defaultGridLayout);
    const activeLayout = isControlled ? gridLayout : internalLayout;
    // Selection state
    const [selectedCameras, setSelectedCameras] = React.useState(new Set());
    // Resolve height
    const resolvedHeight = React.useMemo(() => {
        if (typeof height === 'number')
            return `${height}px`;
    ...
    const handleToggleSelect = React.useCallback((streamId) => {
    ...
    const getCameraId = React.useCallback((stream) => {
    ...
    const openInLayout = React.useCallback(() => {
    ...
    if (loading) {
        return (jsxRuntime.jsx("div", { className: cn('flex flex-col bg-white', className), style: { height: resolvedHeight }, children: jsxRuntime.jsx("div", { className: "flex items-center justify-center flex-1", children: jsxRuntime.jsx(antd.Spin, { size: "large" }) }) }));
    }
    // Render empty state
    if (displayedStreams.length === 0) {
        return (jsxRuntime.jsx("div", { className: cn('flex flex-col bg-white', className), style: { height: resolvedHeight }, children: emptyState ?? (jsxRuntime.jsx("div", { className: "flex items-center justify-center flex-1", children: jsxRuntime.jsxs("div", { className: "text-center text-gray-500", children: [jsxRuntime.jsx("svg", { className: "w-16 h-16 mx-auto mb-4 opacity-50", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 1.5, d: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" }) }), jsxRuntime.jsx("p", { className: "text-lg font-medium", children: "No cameras available" }), jsxRuntime.jsx("p", { className: "text-sm text-gray-400 mt-1", children: "Add cameras to view them here" })] }) })) }));
    }
    return (jsxRuntime.jsxs("div", { className: cn('flex flex-col bg-white', className), style: { height: resolvedHeight }, children: [(showLayoutSelector || title) && (jsxRuntime.jsx("div", { className: "bg-white border-b border-gray-200 px-4 py-3", children: jsxRuntime.jsxs("div", { className: "flex justify-between items-center", children: [jsxRuntime.jsx("div", { className: "flex items-center gap-3", children: title && (jsxRuntime.jsx("span", { className: "text-base font-semibold text-blue-600 border-b-2 border-blue-600 pb-1 px-1", children: title })) }), jsxRuntime.jsxs("div", { className: "flex items-center gap-3", children: [showLayoutSelector && (jsxRuntime.jsxs("div", { className: "flex items-center gap-1 flex-wrap", children: [jsxRuntime.jsx("svg", { className: "w-4 h-4 text-gray-600", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" }) }), jsxRuntime.jsx("span", { className: "text-xs font-medium text-gray-600 mr-1", children: "Change pattern" }), availableLayouts.map((layout) => (jsxRuntime.jsx("button", { onClick: () => handleLayoutChange(layout), className: cn('px-3 py-1.5 text-xs font-semibold rounded-md transition-colors', activeLayout === layout
                                                ? 'bg-gray-800 text-white'
                                                : 'text-gray-600 hover:bg-gray-100'), title: GRID_CONFIGS[layout].label, children: layout.toUpperCase() }, layout)))] })), enableOpenInLayout && (jsxRuntime.jsxs("button", { onClick: openInLayout, disabled: displayedStreams.length === 0, className: cn('flex items-center gap-2 px-4 py-2 rounded-md transition-colors shadow-sm', displayedStreams.length > 0
                                        ...
                                        : "No cameras to open", children: [jsxRuntime.jsx("svg", { className: "w-4 h-4", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) }), jsxRuntime.jsx("span", { className: "text-xs font-semibold", children: selectedCameras.size > 0 ? `Open Layout (${selectedCameras.size})` : 'Open Layout' })] }))] })] }) })), jsxRuntime.jsxs("div", { className: "flex-1 p-4 bg-gray-100 overflow-auto", children: [jsxRuntime.jsxs("div", { className: cn('grid gap-2', gridClasses), children: [displayedStreams.map((stream, index) => (jsxRuntime.jsx("div", { className: "aspect-video", children: jsxRuntime.jsx(WHEPVideoTile, { stream: stream, index: index, whepConfig: whepConfig, showLabel: showTileLabels, labelPlacement: tileLabelPlacement, showControls: showTileControls, enableSelection: enableTileSelection, isSelected: selectedCameras.has(stream.id), onToggleSelect: handleToggleSelect, onClick: onTileClick ? handleTileClick : undefined, onError: handleStreamError, className: "w-full h-full" }) }, stream.id))), Array.from({ length: Math.max(0, layoutConfig.max - displayedStreams.length) }).map((_, index) => (jsxRuntime.jsx("div", { className: "aspect-video", children: jsxRuntime.jsx(WHEPVideoTile, { stream: undefined, index: displayedStreams.length + index, whepConfig: whepConfig, className: "w-full h-full" }) }, `empty-${index}`)))] }), enableTileSelection && selectedCameras.size > 0 && (jsxRuntime.jsxs("div", { className: "mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg flex items-center justify-between", children: [jsxRuntime.jsxs("div", { className: "flex items-center gap-2", children: [jsxRuntime.jsxs("span", { className: "text-sm font-medium text-blue-600", children: [selectedCameras.size, " camera", selectedCameras.size !== 1 ? 's' : '', " selected"] }), jsxRuntime.jsx("button", { onClick: clearSelection, className: "text-xs text-gray-500 hover:text-gray-700 underline", children: "Clear selection" })] }), enableOpenInLayout && (jsxRuntime.jsxs("button", { onClick: openInLayout, className: "flex items-center gap-2 px-3 py-1.5 bg-blue-600 text-white text-xs font-semibold rounded-md hover:bg-blue-700 transition-colors", children: [jsxRuntime.jsx("svg", { className: "w-3 h-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: jsxRuntime.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) }), "Open ", selectedCameras.size, " in Layout"] }))] }))] })] }));
};
...
exports.LiveFeedWhep = LiveFeedWhep;
exports.LiveVideos = LiveVideos;
exports.LiveVideosWhep = LiveVideosWhep;
...
exports.WHEPVideoTile = WHEPVideoTile;
exports.cn = cn;
